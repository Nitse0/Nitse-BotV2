...
┃ _Ex : ${prefix}Ephoto 25 Nitse_
┠⊷️ *${prefix}Textpro list*
┃ _Lista de textpro
┠⊷️ *${prefix}Textpro (code + Texto)*
┃ _Ex : ${prefix}Textpro 55 Nitse_
┗━━━━━━━━━━━━━━━━━━━━
*〘 IMAGENES 〙*
┏━━━━━━━━━━━━━━━━━━━━
┠⊷️ *${prefix}Cogan*
...
//-- temp
			...
			case 'getvn':
				...
				Lxa.sendMessage(from, buffer, audio, { mimetype: 'audio/mp4', quoted: mek, ptt: true })
				  ...
				  reply('No está registrado ese paquete')
				}
				break
...
//--Convert stiker to image
				case 'toimg':
					...
					exec(`ffmpeg -i ${medimg} ${ran}`, (err) => {
						...
						buffer = fs.readFileSync(ran)
						Lxa.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nitse-Bot'})
						fs.unlinkSync(ran)
					})
					break
...
case 'bot':
					...
					if (anu.error) return reply('No lo sé')
					reply(anu.jawaban)
					} catch {
					  reply(mess.ferr)
					}
